...
node has a row, head freshness, the AGENTS.md stamp, and that cited scripts still exist.
...
A lineage closes on a **live gate**, never on an offline read (AGENTS.md rule 6). An
