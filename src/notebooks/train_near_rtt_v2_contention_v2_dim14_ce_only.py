...
"""Train dim14 CE-only from scratch on contention_v2 cache (711 graphs)."""
...
def main() -> None:
    ...
    os.environ.setdefault("WANDB_RUN_NAME", "near-rtt-v2-contention-v2-dim14-ce-only")
    os.environ.setdefault(
        "WANDB_TAGS",
        "near-rtt,ce-only,dim14,contention-v2,from-scratch,collision-labels",
    )
