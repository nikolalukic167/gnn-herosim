...
|---|---|---|
| [**fresh_topo_burst_v1**](docs/lineages/fresh_topo_burst_v1.md) | `REGISTERED` | Does `gnnedge0`'s edge over its MP-OFF twin in the burst seat (16/16 environments, 4 topologies, exploratory) hold on up to 12 never-studied topologies? No training; topology is the unit; bars signed before data. |
