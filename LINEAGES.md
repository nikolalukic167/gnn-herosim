...
|---|---|---|
| [**selfpredict_bar_v1**](docs/lineages/selfpredict_bar_v1.md) | `REGISTERED` | How big is the new bar? `peer_greedy_selfpredict_network` beat the rule −6.2/−8.5 % in `lookahead_mp_v1`, with no Knative or CD arm. Live gate, signed: vs Knative, the rule (replication), the CD greedy, ECT and random, one commit. |
