...
|---|---|---|
| [**lookahead_mp_v1**](docs/lineages/lookahead_mp_v1.md) | `ACTIVE` | **`GO-P1`.** Live P0: an oracle that knows where unarrived partners run beats the rule −6.6 % (C40) / −8.2 % (C80), 15/16 each; the two-step hand guess recovers 2–7 %. Oracle may be coordination, not prediction — P0b hand control next. |
