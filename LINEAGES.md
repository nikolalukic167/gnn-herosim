...
| [**rollout_imitation_v1**](docs/lineages/rollout_imitation_v1.md) | `ACTIVE` | One step of policy improvement over the immediate rule (forced-placement rollouts, group-local cost). Phase A PASSED 2026-09-21: R0 label is horizon-stable (Spearman 1.0, argmin 88.6%, n=440 — NOT chaos) and R1 differs from the rule on 69.3% of decisions. Next: corpus + train gnnedge0/mpoff on the rollout label, gate vs rule/reactive/twin/CD greedy. |
