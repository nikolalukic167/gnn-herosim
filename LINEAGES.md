...
|---|---|---|
| [**lookahead_mp_v1**](docs/lineages/lookahead_mp_v1.md) | `REGISTERED` | Can MP beat its twin by pricing partners not yet arrived? The served GNN never sees an out-of-batch partner, and K4's twin co-locates as well as the GNN. P0 (live, signed): an oracle must beat the rule by ≥5 % or the lineage stops. |
