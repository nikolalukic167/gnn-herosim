...
1. Real simulation results (simulation_result_gnn.json) - with per-task state
2. Training/co-simulation artifacts (run_non_unique/gnn_datasets_*)

It identifies where differences occur to improve co-simulation and data generation.
"""
