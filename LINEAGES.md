...
| Lineage | Status | Outcome |
|---|---|---|
| [**peer_only_v1**](docs/lineages/peer_only_v1.md) | `CLOSED` | **PEERONLY-BEATS-POINTWISE at 80 servers** — `peeronly` beats its MP-OFF twin −15.68 % (16/16, p=0.0004) and reactive −41.4 % (16/16), the program's first arm to beat both. But it loses to `mpoff` at 516 by +10.40 % (0/16), B1 reads CORPUS-DOES-NOT-HELP 6/6, the rung is saturated, and the offline ranking is exactly inverted. |
