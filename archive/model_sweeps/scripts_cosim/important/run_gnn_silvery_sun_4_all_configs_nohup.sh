...
OUT_ROOT="simulation_data/normal_sim_sweeps/gnn_silvery_sun_4_${TS}"
CFG_DIR="${OUT_ROOT}/configs"
RES_DIR="${OUT_ROOT}/results"
PROGRESS_LOG="logs/gnn_silvery_sun_4_sweep_${TS}.log"
...
MODEL_PATH="models/silvery-sun-4.pt"
TIMEOUT=3600
SEED=42
...
log "=== GNN silvery-sun-4 sweep start ==="
...
log "=== GNN silvery-sun-4 sweep complete ==="
