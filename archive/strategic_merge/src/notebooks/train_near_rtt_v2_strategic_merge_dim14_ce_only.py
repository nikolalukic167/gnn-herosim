...
"""Train dim14 CE-only GNN on strategic merge cache (warmth+sparse+contention_v2, coupled oversample)."""
...
def main() -> None:
    ...
    os.environ.setdefault("WANDB_RUN_NAME", "near-rtt-v2-strategic-merge-wss-cont-v2-dim14-ce-only")
    os.environ.setdefault(
        "WANDB_TAGS",
        "near-rtt,ce-only,dim14,strategic-merge,warmth-v2,sparse-v2,contention-v2,coupled-oversample,deploy",
    )
