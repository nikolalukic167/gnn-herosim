#!/usr/bin/env bash
# Strategic-merge WSSM live gate (node_disk_v2, workload-125-225, ql=100).
# Usage: run_strategic_merge_wss_live_gate_one.sh <knative|mlp|gnn> <config_name> <config_json_path>
set -euo pipefail
...
echo "=== strategic-merge wssm live gate: ${POLICY} / ${CONFIG_NAME} ql=${QL} ==="
