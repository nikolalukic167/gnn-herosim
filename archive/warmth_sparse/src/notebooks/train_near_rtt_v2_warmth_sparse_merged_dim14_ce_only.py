...
"""Train dim14 CE-only from scratch on merged warmth_v2 + sparse_warmth_v2 cache."""
...
def main() -> None:
    ...
    os.environ.setdefault("WANDB_RUN_NAME", "near-rtt-v2-warmth-sparse-merged-dim14-ce-only")
    os.environ.setdefault(
        "WANDB_TAGS",
        "near-rtt,ce-only,dim14,warmth-v2,sparse-v2,merged-cache,from-scratch",
    )
