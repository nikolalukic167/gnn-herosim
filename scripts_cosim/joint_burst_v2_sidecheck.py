...
Called as: joint_burst_v2_sidecheck.py <contract.json> <arm: gnnedge0|mpoff|v4load|v4twin|bc1load|bc1mpoff> <split.json> <want_alpha>
...
def main() -> int:
    ...
    if arm in ("gnnedge0", "v4load", "v4twin", "bc1load"):
