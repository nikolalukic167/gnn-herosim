...
"""Launch near-RTT v2 training with anchored sequence-level soft combo CE."""
...
def main() -> None:
    ...
    os.environ.setdefault("NEAR_RTT_TRAIN_OBJECTIVE", "soft_combo")
    os.environ.setdefault("NEAR_RTT_SOFT_COMBO_TAU", "0.25")
    os.environ.setdefault("NEAR_RTT_SOFT_COMBO_MAX_COMBOS", "4096")
    os.environ.setdefault("WANDB_RUN_NAME", "near-rtt-v2-clean-1230-soft-combo")
    os.environ.setdefault(
        "WANDB_TAGS",
        "near-rtt,loss-v2,soft-combo,anchored-ce,clean-1230,scheduler-adaptive",
    )
