#!/usr/bin/env bash
# One skew3 full gate job (node_disk_v2, skew-merged wssm models or Knative).
# Usage: run_skew3_full_gate_one.sh <gnn|mlp|knative> <config_name> <config_json_path>
#
...
# Knative: per-arrival knative_network with node_disk_v2 physics
# Workload: workload-100-100.json (201k tasks)
# Configs: default_20_20_p50 | default_20_20_degree_skew | 05_sparse_40_40_p25_degree_skew
set -euo pipefail
...
OUT_DIR="${SWEEP_DIR:-simulation_data/normal_sim_sweeps/skew3_full_gate_20260614}/results"
SEED="${SEED:-42}"
...
echo "=== skew3 full gate (${HEROSIM_WARMTH_PHYSICS}): ${POLICY} / ${CONFIG_NAME} ==="
