...
"""Train dim16 CE-only from scratch on Regime B cold-burst CACHE 5.6 (pull observables)."""
...
def main() -> None:
    ...
    os.environ.setdefault(
        "WANDB_RUN_NAME", "near-rtt-v2-regime-b-cold-burst-v1-dim16-ce-only"
    )
    os.environ.setdefault(
        "WANDB_TAGS",
        "near-rtt,ce-only,dim16,pull-obs,regime-b,cold-burst-v1,from-scratch,platform-reuse-v1",
    )
